...
public class ShopAdapter extends RecyclerView.Adapter{
    ...
    public ShopAdapter(List<ShopBean> datas, Context context) {
        this.datas=datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v=View.inflate(context, R.layout.shop_rcv_list,null);
        Vh vh=new Vh(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        vh.time.setText(datas.get(position).getCreatetime()+"");
        ...
        vh.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                eventShow.setImageUrl(datas.get(position).getImages());
    ...
    class Vh extends RecyclerView.ViewHolder{
        ...
        public Vh(View itemView) {
            super(itemView);
            img=itemView.findViewById(R.id.shop_rcv_img);
            price=itemView.findViewById(R.id.shop_rcv_price);
            title=itemView.findViewById(R.id.shop_rcv_title);
            time=itemView.findViewById(R.id.shop_rcv_time);
        }
    }
}
